...
if __name__ == '__main__':
    ...
    while True:
        ...
        if droid_ret == 2:
            o2_zloc = new_zloc
        con_set = connections.setdefault(zloc, set())
        if new_zloc in con_set:
            break
        con_set.add(new_zloc)
        zloc = new_zloc
    print("Finished exploring")
    o2_time = 0
    o2_cells = set([o2_zloc])
    all_cells = set(connections)
    while o2_cells != all_cells:
        o2_time += 1
        new_o2 = o2_cells.union(*(connections[z] for z in o2_cells))
        o2_cells = new_o2
    print(o2_time)
